<template>
    <div>
	  ...
	  <div class="w-full h-full">
		<div class="w-[160px] h-[50px] left-[37px] top-[8rem] absolute bg-emerald-500 rounded-[32px] shadow justify-center items-center gap-2.5 inline-flex">
			<a href="#" class="text-white text-sm font-medium font-['Poppins']" @click="isModalOpen = true">Add New Disturbance</a>
		</div>
		...
		<div class="w-full h-[0px] left-[1412px] top-[311px] absolute origin-top-left rotate-180 border border-zinc-200"></div>
	
		<div class="relative top-[10rem] shadow-md sm:rounded-lg">
			<div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
				<div>
					<button id="dropdownRadioButton" data-dropdown-toggle="dropdownRadio" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:text-black dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
			...
			<table class="w-full text-sm text-left rtl:text-right text-black dark:text-gray-400">
				<thead class="text-xs text-black bg-gray-50 dark:bg-gray-200">
					<tr>
				...
				<tbody>
					<tr class="bg-white border-b dark:bg-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
						<td class="w-4 p-4">
							<div class="flex items-center">
			...
			<DisturbanceModal v-if="isModalOpen" @closeModal="isModalOpen = false" />
		</div>
		</div>
	</div>
</template>
